...
def get(key : str) -> Optional[str]:
	if '.' in key:
		...
		if section in CHINESE_WORDING and name in CHINESE_WORDING[section]:
			return CHINESE_WORDING[section][name]
	if key in CHINESE_WORDING:
		return CHINESE_WORDING[key]
	return None
