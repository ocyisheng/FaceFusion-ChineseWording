...
WORDING: Dict[str, Any] = \
	{
		...
		"compressing_image_succeed": "压缩图像成功",
		"compressing_image_skipped": "跳过压缩图像",
		...
		"help": {
			...
			"temp_frame_quality": "指定用于帧提取的图像质量",
			"keep_temp": "处理后保留临时帧 ",
		...
		"uis": {
			...
			"face_detector_score_slider": "脸部检测器分数",
			...
			"temp_frame_quality_slider": "临时帧图片质量",
